...
class ActorRolloutRefWorker(Worker):
    ...
    def _build_model_optimizer(
        ...
        if role == "actor" and optim_config is not None:
            from verl.utils.torch_functional import get_constant_schedule_with_warmup, get_cosine_schedule_with_warmup, get_exponential_schedule_with_warmup, get_polynomial_schedule_with_warmup
            ...
            gamma = optim_config.get("lm_gamma", 0.96)
            power = optim_config.get("power", 1.03)
            ...
            if warmup_style == "constant":
                ...
                actor_lr_scheduler = get_exponential_schedule_with_warmup(optimizer=actor_optimizer, num_warmup_steps=num_warmup_steps, gemma=gamma)
            elif warmup_style == "polynomial":
                actor_lr_scheduler = get_polynomial_schedule_with_warmup(optimizer=actor_optimizer, num_warmup_steps=num_warmup_steps, num_training_steps=total_steps, power=power)
            else:
