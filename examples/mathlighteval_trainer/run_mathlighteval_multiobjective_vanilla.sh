...
PROJECT_NAME="verl_grpo_mathlighteval"

EXPERIMENT_NAME=${EXPERIMENT_NAME:-"qwen3-8b-mathlighteval-acc-concise-format-vanilla"}
...
TRAIN_FILES="$WORKSPACE/data/mathlighteval/train.parquet"
VALIDATE_FILES="$WORKSPACE/data/mathlighteval/val.parquet"
TEST_FILES="$WORKSPACE/data/mathlighteval/test.parquet"
